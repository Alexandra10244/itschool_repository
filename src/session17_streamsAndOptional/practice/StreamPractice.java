...
public class StreamPractice {
    ...
    public static void main(String[] args) {
        ...
        List<List<Integer>> listOfLists = Arrays.asList(
                ...
                Arrays.asList(3, 3, 3, 49, 7, 8, 89),
                Arrays.asList(88, 2, 3, 9, 7, 8, 21));
...
//        printCountedProducts(products);
    ...
    private static Optional<String> getEmail() {
        return Optional.of("user@goole.com");
    }
    ...
    private static void printListOfCharacters(List<String> input) {
        input.stream()
                .map(StreamPractice::stringToCharList)
    ...
    public static void printContainingSubstring(String input, String substring) {
    ...
    private static void printEvenNumbersWithStream(List<Integer> numbers) {
        List<Integer> eventNumbersStream = numbers.stream()
                .filter(number -> number % 2 == 0)
                .toList();
        System.out.println("Stream approach: " + eventNumbersStream);
    }
